...
//#include<io.h>
// macros
#define MAXINODE 50     // max number of inodes

#define READ 1
#define WRITE 2

#define MAXFILESIZE 2048       // setting file size

#define REGULAR 1       // file type regular or special
#define SPECIAL 2

#define START 0
#define CURRENT 1       // for lseek 0-start, 1-current, 2-End
#define END 2

typedef struct superblock
{
    int TotalInodes;    // total inodes
    int FreeInode;      // free inodes that can be used in future
...
void DisplayHelp()
{
    ...
    printf("fstat : To Dispaly information of file using the Descripter\n");
...
int stat_file(char*name)
{
   ...
   printf("\n-------Statistc information about file -----\n");
   printf(" File name :%s\n",temp->FileName);
   printf("Inode Number %d\n",temp->InodeNumber);
   printf("File size :%d\n",temp->FileSize);
   printf("Actual File Size :%d\n",temp->FileActualSize);
